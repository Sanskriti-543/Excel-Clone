...
function findRowCOl(ele) {                            // ID : row , - , col , -
...
// 1. when cells scrolls , this function should run ---------------------------

$("#cells").scroll(function () {

    //    console.log(this.scrollLeft);          //-----GIVES VALUE OF HOW MUCH IS SCROLLED AT X AXIS (RIGHT)---
    //    console.log(this.scrollLeft);         //-----GIVES VALUE OF HOW MUCH IS SCROLLED AT Y AXIS (TOP)---
     
       
       $("#columns").scrollLeft(this.scrollLeft);     /*  in jQuery , $(this).scrollLeft()  */ 
        $("#rows").scrollTop(this.scrollTop);
    });
    
// 2. (extra)   TO WRITE IN A CELL BY DOUBLE CLICK------------------------------------------
